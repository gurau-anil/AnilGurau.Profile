...
- Create Angular project with ng: `ng new anilgurau.profile.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`anilgurau.profile.client.esproj`).
